...
class Engine:
    ...
    def alpha_beta(self, depth_neg, depth_pos, move, alpha, beta, prev_moves, maximiser):
        ...
        if maximiser:
            for move in moves:
                ...
                # Check the new score. If so, replace the best score.
                if new_score > best_score:
        ...
        if not maximiser:
            for move in moves:
                ...
                # Check new score , replace the best score.
                if new_score < best_score:
                    move_sequence = new_sequence
                    best_score, best_move = new_score, move

                # Check the new score is better than the alpha. If it is, return and break the loop
                if new_score <= alpha:
    ...
    def calculate_minimax(self, depth):
        # shows up true for white & false for black
